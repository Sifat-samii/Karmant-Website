...
export const metadata: Metadata = {
  title: 'Nuclear Outbreak | Riot In Uniform | Karmant (BD)',
  description: 'Nuclear Outbreak - Track from Riot In Uniform EP by Karmant',
}
...
const trackData = {
  title: 'Nuclear Outbreak',
  duration: '05:11',
  epTitle: 'Riot In Uniform',
  epSlug: 'riot-in-uniform',
  artwork: '/images/releases/EPs/riot.png',
  releaseDate: 'April 01 2021',
  description: `A relentless depiction of human made catastrophe where secrecy power and propaganda collide. The track confronts nuclear negligence and its slow violent aftermath exposing poisoned landscapes corrupted science and bodies turned into evidence. It reflects collective denial engineered by authority while life erodes silently beneath official silence and glorified destruction.`,
  lyrics: `A chain of smoke sailing in the sky
Graphite coffin covered in a myth inside
A story that hides in tranquility
Bloody sarcophagus that obstructs reality
Hypotheses & conjectures
Chalkboard, plan departure
Hypocrisy their tradition
Deception, their religion

Manmade accident
Splits strings apart
Municipal Wasteland
Fucking population assault
Radiation measurement
As if nothing happened
Radioactive knowledge
And a cry of distress

People taken away for plague treatment
Poison spreads and reveals itself
Spiral helix begins to reform
A force eats away life every dawn
Mass-produced leukemia in hide
Cancer cells dystopia inside
Physical deformity in every breath
Glorified weapons in our wake

(Guitar solo by Shafat Ahmed Chowdhury; MECHANIX)

Energy manipulation
Propaganda free zone
It's a nuclear outbreak
Now it's all lie in death
Perversions bloom beneath every human disease
Bereavement of a thousand years shall be released

The eye of the universe is in our birth
The eye of the universe is in our death`,
  streaming: {
    bandcamp: 'https://karmant.bandcamp.com/track/nuclear-outbreak',
    spotify: 'https://open.spotify.com/track/49owQB75g3p6ksxHUu2RFY?si=01e97399b2694341',
    apple: 'https://music.apple.com/ca/song/nuclear-outbreak-feat-shafat-ahmed-chowdhury/1560509929',
    youtube: 'https://youtu.be/BESheM9iFlM?si=JbWLhF1XtyOhKG7E',
    amazon: 'https://amazon.com/music/player/tracks/B0917T5MRS?marketplaceId=ATVPDKIKX0DER&musicTerritory=US&ref=dm_sh_yi0HnOCS9xCgSwJbJ08ccU6YS',
    tidal: 'https://tidal.com/track/178731942/u',
    deezer: 'https://link.deezer.com/s/322zH1wBt3h2mQY0m3gIs'
  },
  credits: `Vocal/Bass: Zami Hossain
Guitars: Rumman Sharier, Hasan Zamil
Drums: Naweed Kabir
Guitar Solo: Shafat Ahmed Chowdhury
