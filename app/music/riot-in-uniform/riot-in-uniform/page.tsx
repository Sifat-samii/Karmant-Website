...
export const metadata: Metadata = {
  title: 'Riot in Uniform | Riot In Uniform EP | Karmant (BD)',
  description: 'Riot in Uniform - Track from Riot In Uniform EP by Karmant',
}
...
const trackData = {
  ...
  description: `A defiant anthem rooted in unity resistance and collective courage. The song channels the voice of a generation rising against injustice misinformation and abuse of power drawing strength from history sacrifice and solidarity. It captures the spirit of protest led by students in uniform transforming grief into fearless action and reform.`,
  lyrics: `Stood for their right and dignity
Who the fuck are you?
To judge what they did
Bullet was just a nail in front of their anger
They kicked your shells out with no fear

Because the power was in them, in their unity
And smashed the rumors under their feet
They blew your catastrophic political power
With a roar of 18, was all we could hear

(Guitar solo by Rumman Sharier)

Stand against the war conspiracy
Who the hell are they to ruin its legacy
Oh Listen, what this blood-soaked land says
It's 48 years but still feels like 48 days

And the power is in you, in your unity
Just smash that rumor under your feet
Destroy them pests overcome your fear
Then a roar of '71 we all will hear

(Guitar solo by Rumman Sharier)

It's a Riot, a Riot of this generation
It's a Riot, a Riot to reform
It's a Riot, a Riot for safe roads
It's a Riot, a Riot in uniform`,
  streaming: {
    bandcamp: 'https://karmant.bandcamp.com/track/riot-in-uniform',
    spotify: 'https://open.spotify.com/track/4cyveWYVtN92weqc87uSvj?si=36110774b71b4a69',
    apple: 'https://music.apple.com/ca/song/riot-in-uniform/1560509930',
    youtube: 'https://youtu.be/xnnOpvYDABE?si=3kwTzQGyMNZayyXi',
    amazon: 'https://amazon.com/music/player/tracks/B0917V7BKC?marketplaceId=ATVPDKIKX0DER&musicTerritory=US&ref=dm_sh_OtRiSB6YeRfwn3DoeMOQLvOmV',
    tidal: 'https://tidal.com/track/178731943/u',
    deezer: 'https://link.deezer.com/s/322AY5bI3MUGBzN12tD3r'
  },
